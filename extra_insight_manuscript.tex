...
which uses a similar approach with polymorphism and divergence data

we call this measure ``ultra-selection''
lethal or near lethal.... sufficiently strong to eliminate variants within a few generations and prohibit their appearance even in panels of more than 70,000 individuals

extraINSIGHT
(define)
out of analogy to our INSIGHT method
